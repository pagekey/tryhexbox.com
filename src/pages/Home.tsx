...
export default function Home() {
    ...
    useEffect(() => {
        window.location.replace("https://pagekey.io/hexbox");
    }, []);
                    ...
                    <div className="text-left space-y-6">
                        ...
                        <div className="max-w-[500px] space-y-6">
                            <p className="text-slate-400 text-lg md:text-xl leading-relaxed">
                                We are redirecting you to <span className="text-white">pagekey.io/hexbox</span>. Click below if you aren't redirected automatically or want to watch the pitch.
                            </p>
                        ...
                        <div className="flex flex-wrap gap-4 pt-4">
                            <a href="https://pagekey.io/hexbox">
